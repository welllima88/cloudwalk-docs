class Routes
  def self.navigation
    [
      ...
      { "url" => "cli/params",                                           "view_path" => "cli/tutorial_8_parameters_file"},
      { "url" => "cli/network",                                          "view_path" => "cli/tutorial_9_network"},
      { "url" => "cli/transactions",                                     "view_path" => "cli/tutorial_10_transactions"},
      { "url" => "cli/downloads",                                        "view_path" => "cli/tutorial_11_downloads"},
