class Routes
  def self.navigation
    [
      ...
      { "url" => "guides/logs-patterns/overview",                "view_path" => "guides/logs_patterns/tutorial_1_overview"},
      { "url" => "guides/logs-patterns/anomalies-report",        "view_path" => "guides/logs_patterns/tutorial_2_anomalies_report"},
      { "url" => "guides/logs-patterns/patterns-chart",          "view_path" => "guides/logs_patterns/tutorial_3_patterns_chart"},
      { "url" => "guides/logs-patterns/notifications-settings",  "view_path" => "guides/logs_patterns/tutorial_4_notifications_settings"},
    ]
  end
